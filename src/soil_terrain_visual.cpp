...
private:
    rendering::Heightmap* getHeightmap()
    {
        ...
        if (!scene)
        {
            gzerr << "SoilTerrainVisual: Couldn't acquire scene!" << std::endl;
            return nullptr;
        }
        ...
        {
            gzerr << "SoilTerrainVisual: scene has no heightmap!" << std::endl;
            return nullptr;
        }
        return heightmap;
    }
    ...
    void drillTerrainAt(double x, double y)
    {
        ...
        if (heightmap == nullptr)
        {
            gzerr << "SoilTerrainVisual: Couldn't acquire heightmap!" << std::endl;
            return;
        }
        ...
        hole_drilled_ = true;
        gzlog << "SoilTerrainVisual: A hole has been drilled at ("
